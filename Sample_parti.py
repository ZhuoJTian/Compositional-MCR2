...
def getAttr(NUM_OF_CLIENTS):
    ...
    np.savetxt("./data/CategoryToClients10.txt", CategoryToClients, fmt='%d')
    '''
    CategoryToClients=np.loadtxt("./data/CategoryToClients"+str(NUM_OF_CLIENTS)+".txt")
    '''
    ...
    np.savetxt("./data/LocalDist_niid_test10.txt", LocalDist_test_array, fmt='%d')
    np.savetxt("./data/LocalDist_niid10.txt", LocalDist_train_array, fmt='%d')
    '''
